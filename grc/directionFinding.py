...
import directionFinding_epy_block_0 as epy_block_0  # embedded python block
import sip



class directionFinding(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "directionFinding")
        ...
        # Variables
        ##################################################
        self.vector_size = vector_size = 180
        ...
        self.zeromq_sub_source_0_1 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:60002', 100, False, (-1), '', False)
        self.zeromq_sub_source_0_0 = zeromq.sub_source(gr.sizeof_gr_complex, 1, 'tcp://localhost:60001', 100, False, (-1), '', False)
        ...
        self.blocks_stream_to_vector_0_1 = blocks.stream_to_vector(gr.sizeof_gr_complex*1, vector_size)
        ...
        self.connect((self.blocks_stream_to_vector_0_1, 0), (self.epy_block_0, 2))
        ...
        self.connect((self.blocks_throttle2_0_0, 0), (self.blocks_stream_to_vector_0_0, 0))
        self.connect((self.blocks_throttle2_0_0, 0), (self.qtgui_time_sink_x_0, 1))
        self.connect((self.blocks_throttle2_0_1, 0), (self.blocks_stream_to_vector_0_1, 0))
        self.connect((self.blocks_throttle2_0_1, 0), (self.qtgui_time_sink_x_0, 2))
        ...
        self.connect((self.zeromq_sub_source_0_1, 0), (self.blocks_throttle2_0_1, 0))
    ...
    def set_vector_size(self, vector_size):
        ...
        self.epy_block_0.vector_size = self.vector_size
...
def main(top_block_cls=directionFinding, options=None):
